...
class JobPostsControllerTest < ActionController::TestCase
  ...
  test "should create job_post" do
    assert_difference('JobPost.count') do
      post :create, job_post: { company_id: @job_post.company_id, job_description: @job_post.job_description, job_tag: @job_post.job_tag, job_title: @job_post.job_title, logo: @job_post.logo }
    end
  ...
  test "should update job_post" do
    patch :update, id: @job_post, job_post: { company_id: @job_post.company_id, job_description: @job_post.job_description, job_tag: @job_post.job_tag, job_title: @job_post.job_title, logo: @job_post.logo }
    assert_redirected_to job_post_path(assigns(:job_post))
  end
